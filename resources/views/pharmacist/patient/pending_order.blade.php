                ...
                <tr>
                    ...
                    <td class="action-btn-area">
                        ...
                        <div class="action-btn">
                            ...
                            <a href="{{ route('pharmacist.rx.collection') }}">Go to Uncollected list</a>
                        </div>
                    </td>
                    <td>{{$order->rx->dob ?? ""}}</td>
                    <td>{{ $order->weeks }}</td>
                    ...
                    <td>
                        @if( $order->pendingOrder=="true" && ( date('Y-m-d',strtotime($order->rx->date_needed_by ?? '')) <= $date) ) <span class="badge badge-danger">Pending</span>
                            @elseif( $order->pendingOrder=="true" && (date('Y-m-d',strtotime($order->rx->date_needed_by ?? '')) >= $date) )
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('pharmacist.rx.reorder')}}" id="add_form" method="POST" enctype="multipart/form-data" id="first_form">
                        @csrf
                        <div class="row">
