...
@section('page-heading', 'All Collections')
@section('css')
@stop
@section('content')
                ...
                <tr>
                    ...
                    <td class="action-btn-area">
                        ...
                        <div class="action-btn">
                            <a href="{{ route('pharmacist.rx.collection') }}?surgery={{ $surgery->id }}">View Rxs</a> |
                            <button type="button" onclick="deleteAlert('{{ route('pharmacist.surgery.delete',$surgery->id) }}')" title="Delete" class="text-danger">Remove</button>
                        </div>
                    </td>
