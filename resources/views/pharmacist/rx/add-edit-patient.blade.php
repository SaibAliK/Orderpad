...
<div>
    <form action="{{ route('pharmacist.rx.store') }}" method="POST" class="form">
        @csrf
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 table-responsive">
                    <table class="table table-bordered tbll">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="quantity[]" value="{{ $medication->quantity ?? '' }}" class="form-control" placeholder="Quantity" required=""></td>
                            @if(!empty($_GET['order']) && !empty($rx))
                        ...
                        <tr class="cloneme">
                            <td>
                                {{--<input type="text" class="form-control" name="drug[]" placeholder="Drug" required="">--}}
                                <div class="form-group">
                                    <select class="select2 form-control" name="drug[]" id="">
                                        <option hidden selected="" value="choose">Choose Drug</option>
                                        @foreach($drugs as $drug)
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select class="form-control" name="send_via">
                        <option hidden selected="" value="{{ $rx->surgery->ordering_method  ?? ''}}">{{ $rx->surgery->ordering_method  ?? 'Choose Surgery'}}</option>
        ...
        $(document).ready(function() {
            ...
            $(".open_modal").click(function() {
                if (selectMethod == "email") {
                    ...
                    var MOVE = "{{route('pharmacist.loadOrder')}}"
                }
                $.ajax({
                    type: "POST",
                    url: MOVE,
