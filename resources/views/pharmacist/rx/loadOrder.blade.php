 <div style="width: 80%; margin:auto; line-height: 0.7">
   <div>
     <a href="{{route('pharmacist.export-pdf')}}?requests={{$request}}&fax={{$request['fax']}}&phone={{$request['phone']}}" class="btn btn-sm btn-info" style="float: right;">+ Print</a>
