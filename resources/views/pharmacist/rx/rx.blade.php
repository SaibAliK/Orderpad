            ...
            <tr>
                ...
                <td class="action-btn-area action-btn-area-rx">
                    ...
                    <div class="action-btn">
                        <form action="{{ route('pharmacist.rx.destroy',$rx->id) }}" method="POST">
                        ...
                        <div class="display-block">
                            <a class="font-weight-bold" href="{{ route('pharmacist.rx.medication.all.collect',['id' => $rx->id]) }}">All Collected</a> |
...
<script>
    $(".partially-collect-btn").on('click', function() {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('pharmacist.rx.popup.medication.collection') }}?id=" + id,
