            ...
            <tr>
                ...
                <td class="action-btn-area">
                    ...
                    <div class="action-btn">
                        <a href="{{ route('pharmacist.rx.show',$rx->id) }}" class="view-rx btn btn-sm btn-primary">View</a>
                        {{--@if(empty($rx->note))
                        <a href="#" data-uri="{{route('pharmacist.save_collected_note')}}" type="button" data-rx_id="{{$rx->id ?? ''}}" class="note btn btn-sm btn-success"  id="note">Add Note</a>
                        @else
                        <a href="#" data-uri="{{route('pharmacist.save_collected_note')}}?task=update" data-note="{{$rx->note ?? ''}}" type="button" data-rx_id="{{$rx->id ?? ''}}" class="note btn btn-sm btn-info"  id="update_task">Update Note</a>

                        <a href="#" data-uri="{{route('pharmacist.save_collected_note')}}?task=delete" type="button" data-rx_id="{{$rx->id ?? ''}}" class="note btn btn-sm btn-danger"  id="delete_task">Delete Note</a>
                        @endif--}}
                        <br>
