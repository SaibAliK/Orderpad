...
@section('page-heading', 'Pharmacist Staff List')
@section('css')
@stop
@section('content')

<div class="text-right mb-3">
    <a class="btn btn-primary btn-sm" href="{{ route('pharmacist.staff.create') }}"> <i class="fa fa-plus"></i> Create New Member</a>
</div>
            ...
            <tr>
                ...
                <td class="action-btn-area-pharmacy">
                    ...
                    <div class="action-btn">
                        <form action="{{ route('pharmacist.staff.destroy',$staf->id) }}" method="POST">
                            <a href="{{ route('pharmacist.staff.edit',$staf->id) }}">Edit</a> |
                            @csrf
                            @method('DELETE')
