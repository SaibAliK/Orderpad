 <div style="width: 80%;margin:auto;">
   <div>
     <a href="{{route('pharmacist.export-pdf')}}?requests={{$request ?? ''}}&db_data=true&fax={{$request['fax']}}&phone={{$request['phone']}}" class="btn btn-sm btn-info" style="float: right;">+ Print</a>
