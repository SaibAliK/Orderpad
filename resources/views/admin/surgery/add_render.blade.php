<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Name:</strong>
            <input type="text" name="name" placeholder="Name" value="{{ $surgery->name ?? '' }}" class="form-control form-shadow @error('name') is-invalid @enderror">
            @error('name')
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <table class="table table-bordered tbll">
                    ...
                    <tr class="cloneme">
                        <td width="92%"><input type="text" value="{{ $note->notes }}" class="form-control" name="notes[]" placeholder="Notes" ></td>
