<div>
    <form action="{{ route('rxs.save.func') }}" id="submit" method="POST" class="form">
        ...
        <input type="hidden" name="Overdue" value="{{ $_GET['overdue'] ?? 'false' }}">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input name="date_needed" data-date-format='dd-mm-yyyy' value="{{ $rx->date_needed_by ?? ''}}" autocomplete="off" class="form-control datepicker pl-2">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="send_via" id="send_via_render">
                            <option hidden selected="" value="">
                                Choose Surgery Ordering Method
                            </option>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('input[name="date_needed"]').val(Order_date);
            ...
            function initDatepicker(old = false) {
                ...
                if (!old) {
                    dp1.datepicker('update', Order_date);
                    $("[name='date_needed']").datepicker({
                        dateFormat: 'dd-mm-yy',
                        autoclose: true,
                    //todayHighlight: true,
                }).datepicker('update', Order_date);
                } else {
